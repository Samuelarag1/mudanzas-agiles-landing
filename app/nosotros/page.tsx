...
export default function NosotrosPage() {
  const values = [
    ...
    },
    {
      ...
      title: "Compromiso",
      description:
        "Cada mudanza es única y especial. Nos comprometemos a cuidar tus pertenencias como si fueran nuestras.",
    },
    {
      icon: Target,
      title: "Excelencia",
      description:
        "Buscamos la perfección en cada detalle, desde el primer contacto hasta la entrega final.",
    },
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 font-light max-w-3xl mx-auto leading-relaxed">
              Más de 15 años conectando familias con sus nuevos hogares en todo
              el país
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                La Mudadora nació en 2009 en San Miguel de Tucumán con un sueño
                simple pero ambicioso: hacer que las mudanzas sean una
                experiencia positiva y sin estrés para las familias argentinas.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Lo que comenzó como una pequeña empresa familiar se ha
                convertido en una de las compañías de mudanzas más confiables
                del norte argentino, con servicios que se extienden por todo el
                país.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Brindar servicios de mudanza excepcionales que superen las
                expectativas de nuestros clientes, cuidando cada detalle y
                tratando sus pertenencias con el máximo respeto y
                profesionalismo.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Ser la empresa de mudanzas líder en Argentina, reconocida por
                nuestra innovación, confiabilidad y compromiso con la
                satisfacción del cliente en cada traslado.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {team.map((member, index) => (
              ...
              >
                ...
                <p className="text-[#EE801A] font-semibold mb-2">
                  {member.position}
                </p>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl font-light mb-8 max-w-3xl mx-auto leading-relaxed">
              Contactanos hoy y descubrí por qué somos la opción preferida de
