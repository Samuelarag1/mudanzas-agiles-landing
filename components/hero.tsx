    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <span className="font-bold">Mudanzas nacionales exclusivas y compartidas.</span>{" "}
          ...
          >
            <Button 
              size="lg" 
              className="bg-[#EE801A] hover:bg-[#d6721a] text-white font-bold px-12 py-6 text-xl rounded-full shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-110 group"
            >
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 border-white/80 text-white hover:bg-white hover:text-gray-900 font-bold px-12 py-6 text-xl rounded-full backdrop-blur-sm transition-all duration-500 transform hover:scale-110"
            >
              Ver cómo funciona
            </Button>
          </motion.div>
      ...
      >
        ...
        >
          <span className="text-sm font-semibold mb-2">Descubrí más</span>
