      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-2xl font-bold">Mudanzas Ágiles</h3>
                <p className="text-sm text-gray-400">Tucumán • Argentina</p>
              </div>
            </Link>
            <p className="text-gray-300 leading-relaxed text-lg">
              Tu mudanza en las mejores manos. Profesionalismo y confianza desde Tucumán hacia todo el país.
            </p>
          </div>
          
          <div>
            <h4 className="font-bold text-xl mb-6 text-[#EE801A]">Navegación</h4>
            <ul className="space-y-3 text-gray-300">
              ...
              <li><Link href="#servicios" className="hover:text-white transition-colors cursor-pointer">Servicios</Link></li>
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400 text-lg">
            &copy; 2024 Mudanzas Ágiles. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
